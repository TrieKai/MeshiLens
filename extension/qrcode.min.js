...
module.exports = QRCode;
  ...
  function QRCode(container, options = {}) {
    ...
    const requested = Math.max(120, Number(options.width) || 190);
    const cell = Math.max(1, Math.floor(requested / (modulesCount + quiet * 2)));
    const size = cell * (modulesCount + quiet * 2);
