...
- 配對完成後，以一次受限的 Tabelog 搜尋頁尋找最多三家相似店；依料理、車站／地區、價位與搜尋卡片的評分／評論數排序，不會自動讀取推薦店詳情或評論；點擊推薦卡會以店名與地址在 Google Maps 開啟
...
- 中低信心時列出未選中的其他候選店家，讓使用者手動切換；候選以「高信心／待確認／低信心」呈現，而非機率百分比
