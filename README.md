...
- 配對完成後，以一次受限的 Tabelog 店家專屬「附近店家」頁尋找最多三家相似且附近的店；已知料理類別才使用其官方附近分類頁，其他類別必須仍有同料理、價位等明確訊號才推薦，避免把泛附近餐廳誤當相似店家；不會自動讀取推薦店詳情或評論；點擊推薦卡會以店名與地址在 Google Maps 開啟
...
- 相似店家只在已配對店家後進行一次附近頁查詢，最多處理前 20 筆並快取；不批量掃描、不抓推薦店詳情或評論，也不在推薦搜尋失敗時擴大重試或改用外部搜尋。
